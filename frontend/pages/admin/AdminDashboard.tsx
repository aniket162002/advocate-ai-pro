...
import CircleRateManager from '../../components/admin/CircleRateManager';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{stats?.documentsGenerated || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">₹{stats?.revenueThisMonth?.toLocaleString() || 0}</div>
