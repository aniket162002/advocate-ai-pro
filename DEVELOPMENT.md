...
```bash
git remote add encore encore://advocate-ai-pro-iv5i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/advocate-ai-pro-iv5i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/advocate-ai-pro-iv5i/settings/integrations/github)
